...
CREATE TABLE `oms_order_parcel`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 144 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = '包裹表' ROW_FORMAT = Dynamic;
