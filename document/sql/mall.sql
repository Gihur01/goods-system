...
CREATE TABLE `oms_order`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 146 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `oms_order_item`  (
  ...
  `delete_status` int(1) NOT NULL DEFAULT 0 COMMENT '删除状态：0->未删除；1->已删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 152 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单中所包含的商品' ROW_FORMAT = Dynamic;
...
INSERT INTO `oms_order_item` VALUES (138, NULL, NULL, 118, 3, NULL, NULL, NULL, NULL, 2002, '无线蓝牙耳机', '7437789', NULL, 'TWS-X3-WHITE', 199.00, 2, '颜色：白色；版本：标准版', '支持7天无理由退货', NULL, NULL, NULL, NULL, NULL, 0, 0, 0);
...
INSERT INTO `oms_order_item` VALUES (148, NULL, NULL, 149, NULL, NULL, NULL, NULL, NULL, NULL, '无线蓝牙耳机', '7437789', NULL, NULL, 199.00, 2, NULL, '黑色', NULL, NULL, NULL, NULL, NULL, 0, 0, 0);
INSERT INTO `oms_order_item` VALUES (149, NULL, NULL, 150, NULL, NULL, NULL, NULL, NULL, NULL, '小米手机 Redmi Note 12 Pro', '7437788', NULL, NULL, 2999.00, 1, NULL, '红色', NULL, NULL, NULL, NULL, NULL, 0, 0, 0);
INSERT INTO `oms_order_item` VALUES (150, NULL, NULL, 151, NULL, NULL, NULL, NULL, NULL, NULL, '小米手机 Redmi Note 12 Pro', '7437788', NULL, NULL, 2999.00, 1, NULL, '红色', NULL, NULL, NULL, NULL, NULL, 0, 0, 0);
INSERT INTO `oms_order_item` VALUES (151, NULL, NULL, 152, NULL, NULL, NULL, NULL, NULL, NULL, '无线蓝牙耳机', '7437789', NULL, NULL, 199.00, 2, NULL, '黑色', NULL, NULL, NULL, NULL, NULL, 0, 0, 0);
...
CREATE TABLE `oms_order_parcel`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 153 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci COMMENT = '包裹表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_admin_login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 465 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '后台用户登录日志表' ROW_FORMAT = Dynamic;
